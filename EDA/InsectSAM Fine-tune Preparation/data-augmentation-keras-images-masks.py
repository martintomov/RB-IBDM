...
Screws up labels for binary / multinary masks used for semantic segmentation as it interpolates pixels during transformation. 
...
x_img = io.imread('diopsis_public_classification_clean/rb-ibdm-dataset/finetune-dataset/image')
x_mask = io.imread('diopsis_public_classification_clean/rb-ibdm-dataset/finetune-dataset/label')
