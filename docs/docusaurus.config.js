...
const config = {
  ...
  organizationName: 'martintmv-git', // Usually your GitHub org/user name.
  projectName: 'RB-IBDM', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/rb-ibdm-social-card.jpg',
      navbar: {
        title: 'RB-IBDM 🐞',
        items: [
          {
